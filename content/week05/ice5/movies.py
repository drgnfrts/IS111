...
print(movies_utility.get_average_duration(movie_list_2))
...
print(movies_utility.get_num_movies_of_genre(movie_list_2, "fantasy"))

print(movies_utility.get_title_of_longest_movie(movie_list))
print(movies_utility.get_title_of_longest_movie(movie_list_2))

print(movies_utility.get_movies_with_keyword(movie_list, "King"))
print(movies_utility.get_movies_with_keyword(movie_list, "Lord"))
print(movies_utility.get_movies_with_keyword(movie_list_2, "Lord"))
